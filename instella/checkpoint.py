...
from instella import util

from .aliases import PathOrStr
from .config import BaseConfig, ShardedCheckpointerType, TrainConfig
from .exceptions import InstellaCheckpointError
            ...
            with ThreadPoolExecutor(max_workers=self.thread_count) as executor:
                ...
                for f in as_completed(futures):
                    try:
                        ...
                        raise InstellaCheckpointError(f"Original error:\n{traceback.format_exc()}")
        return fut
...
class InstellaCoreCheckpointer(Checkpointer):
    def save_checkpoint(
        self,
        dir: PathOrStr,
        dist_model: nn.Module,
...
def build_sharded_checkpointer(
    ...
    if name == ShardedCheckpointerType.torch_new:
        ...
        return InstellaCoreCheckpointer(cfg)
    else:
